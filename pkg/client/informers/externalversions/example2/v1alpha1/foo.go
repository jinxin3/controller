...
import (
	...
	example2v1alpha1 "github.com/jinxin3/controller/pkg/apis/example2/v1alpha1"
	versioned "github.com/jinxin3/controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/jinxin3/controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/jinxin3/controller/pkg/client/listers/example2/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Example2V1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Example2V1alpha1().Foos(namespace).Watch(options)
			},
		},
		&example2v1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&example2v1alpha1.Foo{}, f.defaultInformer)
}
