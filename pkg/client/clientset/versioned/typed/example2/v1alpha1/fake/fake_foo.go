...
type FakeFoos struct {
	Fake *FakeExample2V1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "example2", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "example2", Version: "v1alpha1", Kind: "Foo"}
